...
const Shell: React.FC<ShellProps> = ({ children, stats }) => {
  return (
    <div className="h-screen w-screen flex flex-col bg-ark-bg text-ark-text overflow-hidden select-none">
      {/* Top Navigation Bar */}
      <header className="h-16 bg-zinc-900/90 backdrop-blur-md border-b border-zinc-800 flex items-center justify-between px-6 z-50 shadow-lg relative">
        {/* Deco lines */}
        ...
        <div className="flex items-center gap-6">
           ...
           <div className="flex items-center gap-3">
              ...
              <div className="leading-none">
                ...
                <p className="text-[10px] tracking-[0.2em] text-gray-500">TACTICAL TERMINAL</p>
              </div>
           </div>
        </div>

        {/* Resources with Math Metaphors */}
        <div className="flex items-center gap-6 md:gap-12 font-mono text-sm">
           <div className="flex items-center gap-3 group cursor-help">
              ...
              <div className="flex flex-col leading-none">
                 <span className="text-[9px] text-gray-500 uppercase tracking-wider mb-0.5 group-hover:text-blue-400">Computational Power</span>
                 ...
                 <span className="text-[9px] text-gray-600 scale-90 origin-left">理智 / 算力极限</span>
              </div>
           </div>
      ...
      <div className="fixed bottom-4 left-6 text-[10px] text-gray-600 font-mono pointer-events-none z-50 flex flex-col gap-1">
