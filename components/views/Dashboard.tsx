...
import { Activity, Shield, Battery, Database, Cpu } from 'lucide-react';
          ...
          <div className="grid grid-cols-2 gap-4">
             ...
             >
                ...
                <div className="z-10 text-left relative">
                  <div className="text-6xl font-black italic tracking-tighter text-white/10 absolute -top-8 -left-4 select-none">COMBAT</div>
                  <h2 className="text-4xl font-black italic tracking-widest text-white group-hover:text-ark-accent transition-colors drop-shadow-md">
                    作战 <span className="text-xl not-italic font-normal opacity-70">COMBAT</span>
                  </h2>
                  <p className="text-blue-200 text-xs font-mono mt-2 tracking-widest">当前行动：CA-1 导数与DPS分析</p>
                </div>
                
                <div className="relative z-10">
                    <Activity className="w-24 h-24 text-blue-500/20 group-hover:text-ark-accent/60 transition-all rotate-12" />
                </div>
             ...
             >
                <Database className="w-8 h-8 text-gray-500 group-hover:text-ark-yellow mb-4 group-hover:scale-110 transition-transform duration-300" />
                <div className="z-10">
                  <h3 className="text-xl font-bold tracking-wider">情报 <span className="text-xs text-gray-500 font-mono">ARCHIVES</span></h3>
                  <p className="text-xs text-gray-400 mt-1">数学概念资料库</p>
                </div>
                <div className="absolute -right-4 -bottom-4 text-8xl font-black text-white/5 rotate-[-15deg]">LIB</div>
             </div>
             ...
             <div 
               ...
               className="bg-zinc-800/60 border border-zinc-600 hover:bg-zinc-700/80 hover:border-gray-400 p-6 cursor-pointer flex flex-col justify-between group transition-all h-32 relative overflow-hidden"
             >
                <Cpu className="w-8 h-8 text-gray-500 group-hover:text-green-400 mb-4 group-hover:scale-110 transition-transform duration-300" />
                <div className="z-10">
                  <h3 className="text-xl font-bold tracking-wider">终端 <span className="text-xs text-gray-500 font-mono">PRTS</span></h3>
                  <p className="text-xs text-gray-400 mt-1">AI 代理指挥</p>
                </div>
                <div className="absolute -right-4 -bottom-4 text-8xl font-black text-white/5 rotate-[-15deg]">AI</div>
             </div>
